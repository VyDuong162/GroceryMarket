                ...
                <div class="news-content-right pd-20">
                    <form name="frmCreate" id="frmCreate" method="post" action="{{ route('admin.sanpham.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sp_ten" id="sp_ten" class="form-control" value="{{ old('sp_ten') }}" placeholder="ví dụ:Cà phê sữa VinaCafé Gold Original 800g">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="dgmh_gia" id="dgmh_gia" value="{{ old('dgmh_gia') }}">                
                        </div>
                        <div class="form-group">
